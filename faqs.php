  		...
  		<div class="row">
  			<div class="twelve columns faqs">
	  			...
	  			<ul class="accordion">
					<li class="active">
					    <div class="title">
					      <h5>I would like to check out a Panorama Toastmasters meeting. What should I do?</h5>
					    </div>
					    <div class="content">
					    <p>
					...
					<li >
					    <div class="title">
					      <h5>What if I decide to join Toastmasters? Is there a membership fee?</h5>
					    </div>
					    <div class="content">
						<p>
					...
					<li >
					    <div class="title">
					      <h5>How many people usually attend meetings?</h5>
					    </div>
					    <div class="content">
							<p>Meeting attendance varies but typically there are around ~15-20 people who attend meetings each week. It is a very low pressure, supportive environment.</p>
					    </div>
				  	</li>

					<li >
					    <div class="title">
					      <h5>I am really bad at public speaking. Will I embarrass myself as new person?</h5>
					    </div>
					    <div class="content">
							<p>No way! People who join Toastmasters do so because they want to work on their public speaking. We have a supportive environment and we all remember our first time speaking where many of us probably had similar concerns. Our members vary widely in their experience but we all do our best to help each other become better speakers. I bet you are not as bad as you think!</p>
					    </div>
				  	</li>

					<li >
					    <div class="title">
					      <h5>Am I pressured or forced to do anything as a member of Toastmasters?</h5>
					    </div>
					    <div class="content">
							<p>
					...
					<li >
					    <div class="title">
					      <h5>Where does the name Panorama come from?</h5>
					    </div>
					    <div class="content">
						<p>
