  ...
  <table class="twelve speaker">
        ...
        <tr>
          <td class="foo">
           ...
           <td>
 To begin speaking before an audience","To discover speaking skills you already have and skills that need some attention","To introduce yourself to your fellow club members.
          </td>
        </tr> 
        <tr>
          <td class="foo">
